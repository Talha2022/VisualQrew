            ...
            <div className="relative z-10 mx-auto max-w-4xl">
                ...
                <div className="flex flex-col gap-12 lg:flex-row lg:items-start lg:gap-20">
                    ...
                    <div className="lg:w-2/5">
                        ...
                        <h2 className="text-3xl uppercase tracking-tight text-white sm:text-4xl leading-tight" style={{ fontFamily: "'Milligram', sans-serif", fontWeight: 900, letterSpacing: '-0.03em' }}>
